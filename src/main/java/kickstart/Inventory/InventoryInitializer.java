...
public class InventoryInitializer implements DataInitializer {
	...
	@Override
		public void initialize() {
			...
			shopProductCatalog.save(new Book("Sapiens: A Brief History of Humankind", "/resources/img/cover/sapiens.jpg",
				Money.of(14.99, "EUR"), "Explores the history of humankind", genreSet2, "Yuval Noah Harari",
				"9780062316110", "Harper"));

			shopProductCatalog.save(new Book("Harry Potter and the Sorcerer's Stone", "/resources/img/cover/harry.jpg",
				Money.of(8.99, "EUR"),"A young wizard's journey begins", genreSet3, "J.K. Rowling", "9780590353427", "Scholastic"));
			...
			shopProductCatalog.save(new Book("The Art of War", "/resources/img/cover/artofwar.jpg", Money.of(6.99,"EUR"),
				"Timeless strategies and wisdom on warfare, leadership and strategy by Sun Tzu",genreSet6,
				"Sun Tzu","9781721195091","CreateSpace Independent Publishing Platform"));

			shopProductCatalog.save(new Book("The Godfather", "/resources/img/cover/godfather.jpg", Money.of(29.99,"EUR"),
				"A powerful saga of crime, family, and loyalty in the world of the Mafia",
				genreSet7,"Mario Puzo","9780099528128","Arrow"));
			...
			Book snoopBook = (new Book("From Crook To Cook: Platinum Recipes From Tha Boss Dogg's Kitchen",
				"/resources/img/cover/snoopdogg.jpg",Money.of(99.99,"EUR"), "Best Recipes world wide",genreSet9,"Snoop Dogg",
				"9781452179612","Chronicle Books"));
			shopProductCatalog.save(snoopBook);

			shopProductCatalog.save (new Merch("T-Shirt", "/resources/img/cover/t-shirt.jpg",
				Money.of(19.99, "EUR"), "Comfortable cotton T-shirt"));
			shopProductCatalog.save (new Merch("Mug", "/resources/img/cover/mug.jpg",
				Money.of(9.99, "EUR"), "Ceramic coffee mug"));
			shopProductCatalog.save (new Merch("Cap", "/resources/img/cover/cap.jpg",
				Money.of(14.99, "EUR"), "Stylish baseball cap"));
			shopProductCatalog.save (new Merch("Poster", "/resources/img/cover/poster.jpg",
				Money.of(5.99, "EUR"), "Decorative wall poster"));
			...
			shopProductCatalog.save(new Calendar("Space Exploration 2025", "/resources/img/cover/space2025.jpg",
				Money.of(15.99, "EUR"), "Explore the wonders of space with breathtaking images each month."));

			shopProductCatalog.save(new Calendar("Historical Monuments 2025", "/resources/img/cover/history2025.jpg",
				Money.of(10.99, "EUR"), "A calendar showcasing famous historical monuments from around the world."));

			shopProductCatalog.save(new Calendar("Wildlife Photography 2025", "/resources/img/cover/wildlife2025.jpg",
				Money.of(14.99, "EUR"), "Each month features stunning photographs of wildlife in their natural habitats."));
