...
public class InventoryInitializer implements DataInitializer {
	...
	InventoryInitializer(UniqueInventory<UniqueInventoryItem> shopProductInventory, ShopProductCatalog shopProductCatalog) {
		...
		public void initialize() {
			...
			shopProductCatalog.save(new Book("The Great Gatsby", "gatsby.jpg", Money.of(10.99, "USD"),
				"A novel set in the 1920s about the American Dream", fiction, "F. Scott Fitzgerald",
				"9780743273565", "Scribner"));

			shopProductCatalog.save(new Book("Sapiens: A Brief History of Humankind", "sapiens.jpg", Money.of(14.99, "USD"),
				"Explores the history of humankind", history, "Yuval Noah Harari",
				"9780062316110", "Harper"));

			shopProductCatalog.save(new Book("Harry Potter and the Sorcerer's Stone", "hp1.jpg", Money.of(8.99, "USD"),
				"A young wizard's journey begins", adventure, "J.K. Rowling",
				"9780590353427", "Scholastic"));

			shopProductCatalog.save(new Book("The revolution", "the_revolution.jpg", Money.of(12.99, "USD"),
				"An exploration of cosmology by Stephen Hawking", history, "Stephen Hawking",
				"9780553380163", "Bantam"));

			shopProductCatalog.save (new Merch("T-Shirt", "image1.jpg", Money.of(19.99, "USD"), "Comfortable cotton T-shirt"));
			shopProductCatalog.save (new Merch("Mug", "image2.jpg", Money.of(9.99, "USD"), "Ceramic coffee mug"));
			shopProductCatalog.save (new Merch("Cap", "image3.jpg", Money.of(14.99, "USD"), "Stylish baseball cap"));
			shopProductCatalog.save (new Merch("Poster", "image4.jpg", Money.of(5.99, "USD"), "Decorative wall poster"));

			shopProductCatalog.save(new Calendar("Nature 2024", "nature_calendar.jpg", Money.of(12.99, "USD"),
				"A calendar featuring beautiful nature landscapes for each month."));

			shopProductCatalog.save(new Calendar("Space Exploration 2024", "space_calendar.jpg", Money.of(15.99, "USD"),
				"Explore the wonders of space with breathtaking images each month."));

			shopProductCatalog.save(new Calendar("Historical Monuments 2024", "monuments_calendar.jpg", Money.of(10.99, "USD"),
				"A calendar showcasing famous historical monuments from around the world."));

			shopProductCatalog.save(new Calendar("Wildlife Photography 2024", "wildlife_calendar.jpg", Money.of(14.99, "USD"),
