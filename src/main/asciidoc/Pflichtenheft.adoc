...
|Extensions                 |-
|Functional Requirements    |<<F0220>>, <<F0230>>, <<F0241>>, <<F0244>> , <<F0320>>
|===
...
|Extensions                 |
|Functional Requirements    |<<F0113>>, <<F0114>>
|===
...
|Decrease Quantity
a|
The system shall be able to automatically reduce the stock of a product in the inventory (<<F0100>>), when a product was bought.
...
[[AKD]]
image::./models/analysis/aUMLClassDiagramm/aUML-Bookshop.png[Class diagram, 100%, 100%, pdfwidth=100%, title= "Domain model of {project_name}", align=center]
