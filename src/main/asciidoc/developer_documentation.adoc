...
image::./models/design/General/bookshop.svg[title = class design diagram - bookshop]

=== Catalog


image::models/design/Catalog/juml_catalog.svg[title = class design diagram - catalog]
...
=== Catalog
image::models/design/Catalog/catalog_sequenceDiagram.svg[title = sequence diagram - catalog]
